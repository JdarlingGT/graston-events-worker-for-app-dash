import { Env, WooProduct, ACFEventFields, WooOrder, LearnDashProgress, FluentCrmContact, Venue, Instructor } from './types';
...
export async function fetchVenues(env: Env): Promise<Venue[]> {
  // For now, return mock data from static JSON
  // In production, this would fetch from WordPress custom post type or other source
  try {
...
export async function createVenue(env: Env, venue: Venue): Promise<void> {
  // Placeholder for creating a venue via WordPress REST API
  console.log('Creating venue:', venue);
  // In production, this would POST to WordPress custom post type endpoint
}

export async function fetchInstructors(env: Env): Promise<Instructor[]> {
  // For now, return mock data from static JSON
  // In production, this would fetch from WordPress custom post type or other source
  try {
...
export async function createInstructor(env: Env, instructor: Instructor): Promise<void> {
  // Placeholder for creating an instructor via WordPress REST API
